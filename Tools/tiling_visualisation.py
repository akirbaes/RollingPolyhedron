...
from _libs.GenPngScreenspaceRoller import draw_background, refresh, wait_for_input
...
#match differenciator: -d with +d, else d with d\n"""
    ...
    try:
        os.mkdir("../_resources/tiling_dicts")
    except:
        pass
...
if __name__ == "__main__":
    ...
    if len(sys.argv)>1 and sys.argv[1].endswith(".oldformat"):
        ...
        print(mapping)
        draw_background(screen, mapping, (0,0,0),numbers=True)
